...
class Registration < ApplicationRecord
  ...
  has_attached_file :proof, styles: { thumb: "100x100>" }, :path => ":rails_root/public/uploads/registry/:uuid/:style/:filename", :url => ENV["BASE_URL"]+"/uploads/registry/:uuid/:style/:filename"
