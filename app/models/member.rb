...
class Member < ApplicationRecord
    ...
    has_attached_file :profile, styles: { thumb: "100x100>" }, default_url: ENV["BASE_URL"]+"/images/missing.png", :path => ":rails_root/public/uploads/members/:uuid/:style/:filename", :url => ENV["BASE_URL"]+"/uploads/members/:uuid/:style/:filename"
